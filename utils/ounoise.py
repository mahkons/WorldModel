"""
A Ornstein Uhlenbeck action noise for continuous actions.

Usage:
    * self.noise = noise(mean="mean values of actions", sigma="variance of the noise")
    * action += self.noise()
    * every new iteration: self.noise.reset()
"""
